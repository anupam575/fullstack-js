...
let originalarray = ("originl:", array)
let arr1 = [...array]
let removedElements = arr1.splice(2,4)
console.log("r:",removedElements);
console.log("remin:", arr1);
let arra2 = [...array]
let addelements = arra2.splice(1,2, 'z', 'r')
console.log("A:", addelements);
console.log("B:", arra2);
console.log("\n slic");
console.log("a:", array.slice(4,7));
console.log("b:",array.slice(-2, -6));
